...
while True:
    ...
    if time_waited >= 500:  # 0.5 sekuntia = 500 ms
        ...
        if current_battery_current > 500:
            motor_root_beam.stop()  # Odotetaan 0.1 sekuntia
            print(f"Moottori pysäytettiin, koska akkuvirta {current_battery_current} mA ylitti rajan 500 mA")
            break
